...
* [#586](https://github.com/ckeditor/ckeditor-dev/issues/586) Fixed: The `required` attribute is not correctly recognized by the [Portfolio Editor](https://ckeditor.com/cke4/addon/forms) plugin dialog. Thanks to [Roli Züger](https://github.com/rzueger)!
...
* [#834](https://github.com/ckeditor/ckeditor-dev/issues/834): [IE9-11] Fixed: The editor does not save the selected state of radio buttons inserted by the [Portfolio Editor](https://ckeditor.com/cke4/addon/forms) plugin.
...
* [#11945](https://dev.ckeditor.com/ticket/11945): Fixed: [Portfolio Editor](https://ckeditor.com/cke4/addon/forms) plugin should not change a core method.
...
* [#10430](https://dev.ckeditor.com/ticket/10430): Resolve dependence of the [Image](https://ckeditor.com/cke4/addon/image) plugin on the [Portfolio Editor](https://ckeditor.com/cke4/addon/forms) plugin.
...
* [#9503](https://dev.ckeditor.com/ticket/9503): [Portfolio Editor](https://ckeditor.com/cke4/addon/forms) plugin adds context menu listeners only on supported input types. Added support for `tel`, `email`, `search` and `url` input types.
